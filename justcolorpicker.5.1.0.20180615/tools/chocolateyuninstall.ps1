...
#  softwareName  = 'foo*'  #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
...
#if ($key.Count -eq 1) {
# Remove-RegistryKeyForEveryUser 'Software\Sysinternals\ZoomIt'
